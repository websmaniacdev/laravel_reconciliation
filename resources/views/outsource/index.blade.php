        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-5">
            <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                {{-- <span class="text-xs text-gray-400">Run: <code
                            ...
                            --sync</code></span> --}}
                <button class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-mediumm">
        ...
        <form method="POST" action="{{ route('outsource.upload') }}" enctype="multipart/form-data">
            ...
            <div class="mt-3 bg-indigo-50 border border-indigo-100 rounded-lg px-4 py-3">
                <p class="text-xs text-indigo-700">
                    ...
                    If not processed automatically, run: <code class="font-mono bg-indigo-100 px-1 py-0.5 rounded">php
                        artisan outsource:process-pending
                        --sync</code>
                </p>
            </div>
