...
<main class="max-w-7xl mx-auto px-4 py-6">
    ...
    @if (request()->hasAny(['invoice_number', 'billed_to', 'description', 'from_date', 'to_date']))
        <div class="flex flex-wrap gap-2 mb-4">
            ...
            @endif
            <span class="inline-flex items-center gap-1 bg-gray-100 text-gray-600 text-xs px-2.5 py-1 rounded-full">
    ...
    @if ($pendingPdfs->isNotEmpty())
        <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-5">
            <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <button class="bg-violet-600 hover:bg-violet-700 text-white px-3 py-2 rounded-lg text-sm font-medium">
